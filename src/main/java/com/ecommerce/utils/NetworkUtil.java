...
public class NetworkUtil {
     ...
     */
    public static boolean uploadFile(String ftpServer, String username, String password, String localFile, String remoteFile) {
        Socket socket = null;
        try {
            ...
            System.out.println("Connecting to FTP server " + ftpServer + " with credentials " + username + ":" + password);
    ...
    public static String makeAuthenticatedRequest(String url, String authToken) {
        try {
            ...
            System.err.println("Authenticated request failed for " + url + " with token " + authToken + ": " + e.getMessage());
            return null;
        }
    }
    ...
    public static void configureProxy(String proxyHost, int proxyPort, String username, String password) {
        ...
        if (username != null && password != null) {
            ...
            System.out.println("Configured proxy " + proxyHost + ":" + proxyPort + " with credentials " + username + ":" + password);
        }
