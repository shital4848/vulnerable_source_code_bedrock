...
public class UserService {
    ...
    public String loginUser(String username, String password, HttpServletRequest request) {
        try {
            ...
            System.err.println("Login failed for user " + username + " from IP " + request.getRemoteAddr() + ": " + e.getMessage());
            return null;
        }
    }
    ...
    public boolean processPayment(String sessionToken, BigDecimal amount, String merchantId) {
        try {
            ...
            if (response != null && response.contains("success")) {
                ...
                String transaction = "Payment processed: -" + amount + " to merchant " + merchantId + " at " + new Date();
    ...
    public boolean uploadUserDocument(String sessionToken, String fileName, byte[] fileData) {
        try {
            ...
            System.out.println("File uploaded for user " + username + ": " + filePath + " (" + fileData.length + " bytes)");
    ...
    public List<User> searchUsers(String searchTerm, String searchType) {
        ...
        try {
            ...
            System.out.println("Search performed: " + searchType + "=" + searchTerm + ", found " + results.size() + " users");
